...
class DatabaseTests(unittest.TestCase):
    ...
    def test_admin_panel_has_interactive_flows(self):
        ...
        self.assertIn('"💳 امور مالی": "admin_finance"', labels_source)
        self.assertIn('"🎧 پشتیبانی": "support"', labels_source)
        self.assertIn('"🎧 تیکت‌های پشتیبانی": "admin_support"', labels_source)
        ...
        self.assertIn("atomic_rubika_proxy", compose)
